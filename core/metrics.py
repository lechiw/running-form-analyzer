...
class RunningMetricsCalculator:
    ...
    def get_scoring(self, metrics: RunningMetrics) -> Dict:
        ...
        # Cadence: optimal 170-180 spm, sigmoid decay outside
        # σ=8 means cadence 162-188 scores > 80, 155-195 scores > 50
        if metrics.cadence_avg:
            score_map["cadence"] = _sigmoid_score(metrics.cadence_avg, center=175, width=8)
